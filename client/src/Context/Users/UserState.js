...
const UserState = (props) => {
  ...
  const addUser = async (props) => {
    const response = await fetch(`${URL}/api/user/adduser `, {
      ...
      body: JSON.stringify({ first_name: props.first_name, last_name: props.last_name, email: props.email, gender: props.gender, avatar: props.avatar, domain: props.domain, available: props.available }) 
    });
