                    ...
                    <div className="green card">
                        ...
                        <div className="extra content">
                            <div className="ui two buttons">
                                <div className="ui basic black button" onClick={handleClick} data-bs-toggle="modal" data-bs-target="#exampleModal1">Edit</div>
                                <div className="ui basic black button" onClick={() => { deleteUser(user._id) }}> Delete</div>
                            </div>
                        </div>
                    </div>
                </div>
