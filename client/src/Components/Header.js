  ...
  return (
    <>
      <div className="container mt-3">
        ...
        <Link to="/"><button className="ui big button">
           Main Page
          </button>
          </Link>
          <Link to="/Teams"><button className="ui big button">
      Add New Team
          </button>
          </Link>

          <Link to="/AllTeam"><button className="ui big button blue">
           See All Teams
          </button>
          </Link>
          <div className="right menu">
            <div className="item">
              <div className="ui icon input">
                ...
                />
                <i className="search link icon red"></i>
              </div>
            </div>
          </div>
        </div>
